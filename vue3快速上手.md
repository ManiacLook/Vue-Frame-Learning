...
- 作用: 定义一个<strong style="color:#DD5145">响应式的数据</strong>
...
- 两个小“坑”：
  ...
  - 监视reactive定义的响应式数据（对象）时：oldValue无法正确获取、强制开启了深度监视（deep配置失效）。
  - 监视reactive定义的响应式数据（对象）中某个或某些属性时：oldValue 可以正确获取、deep配置有效。
